...
Review.create! ([
  {
    user_id: 1,
    stars: 5,
    comment: "What a fantastic Movie! I highly recommend it!",
    movie_id: 1
  },
  {
    user_id: 2,
    stars: 4,
    comment: "It was a great action packed movie!",
    movie_id: 1
  },
  {
    user_id: 3,
    stars: 2,
    comment: "I'm not a huge fan of these types of movies. 😃",
    movie_id: 5
  },
  {
    user_id: 4,
  ...
  User.create! ([
    {
      ...
      email: "jgrabenbauer90@gmail.com",
      password: "Inytw?65",
      password_confirmation: "Inytw?65",
      username: "jgrabenbauer",
      admin: true
    },
    {
      name: "Justin",
      email: "justin.grabenbauer@icloud.com",
      password: "password1234",
      password_confirmation: "password1234",
      username: "jgrabenbauer90",
      admin: false
    },
    {
      name: "Brian Johnson",
      email: "brian@clickfunnels.com",
      password: "password1234",
      password_confirmation: "password1234",
